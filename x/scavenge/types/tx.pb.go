...
func init() {
	proto.RegisterType((*MsgSubmitScavenge)(nil), "mehdisbys.scavenge.scavenge.MsgSubmitScavenge")
	proto.RegisterType((*MsgSubmitScavengeResponse)(nil), "mehdisbys.scavenge.scavenge.MsgSubmitScavengeResponse")
	proto.RegisterType((*MsgCommitSolution)(nil), "mehdisbys.scavenge.scavenge.MsgCommitSolution")
	proto.RegisterType((*MsgCommitSolutionResponse)(nil), "mehdisbys.scavenge.scavenge.MsgCommitSolutionResponse")
	proto.RegisterType((*MsgRevealSolution)(nil), "mehdisbys.scavenge.scavenge.MsgRevealSolution")
	proto.RegisterType((*MsgRevealSolutionResponse)(nil), "mehdisbys.scavenge.scavenge.MsgRevealSolutionResponse")
}
...
var fileDescriptor_62ec6f1544538068 = []byte{
	...
	0x4d, 0xcd, 0x48, 0xc9, 0x2c, 0x4e, 0xaa, 0x2c, 0xd6, 0x83, 0x49, 0xc2, 0x19, 0x4a, 0xdd, 0x8c,
	...
	0xff, 0xff, 0x57, 0x15, 0xea, 0x4a, 0xb2, 0x03, 0x00, 0x00,
}
...
func (c *msgClient) SubmitScavenge(ctx context.Context, in *MsgSubmitScavenge, opts ...grpc.CallOption) (*MsgSubmitScavengeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mehdisbys.scavenge.scavenge.Msg/SubmitScavenge", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) CommitSolution(ctx context.Context, in *MsgCommitSolution, opts ...grpc.CallOption) (*MsgCommitSolutionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mehdisbys.scavenge.scavenge.Msg/CommitSolution", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) RevealSolution(ctx context.Context, in *MsgRevealSolution, opts ...grpc.CallOption) (*MsgRevealSolutionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mehdisbys.scavenge.scavenge.Msg/RevealSolution", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SubmitScavenge_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mehdisbys.scavenge.scavenge.Msg/SubmitScavenge",
	}
...
func _Msg_CommitSolution_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mehdisbys.scavenge.scavenge.Msg/CommitSolution",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_RevealSolution_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mehdisbys.scavenge.scavenge.Msg/RevealSolution",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "mehdisbys.scavenge.scavenge.Msg",
